...
export class ReceiverAdd extends React.PureComponent<Props> {
  constructor(props) {
    super(props)
    this.state = {}
  }
...
rules: [{ required: true, message: '请输入收货方客户代码' }],
  ...
  handleSubmit(e){
    ...
    this.props.form.validateFieldsAndScroll((err, values) => {
      ...
      axios.post(api.receiptor.add, {...values, primaeval_customer:this.props.id}).then(res => {
...
export default Form.create()(ReceiverAdd) 
